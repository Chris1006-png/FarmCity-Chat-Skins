 ...
 */
export const updateProfile = async (profileUpdate: ProfileUpdate, options?: Parameters<typeof customFetch>[1]): Promise<AuthResponse> => {
 ...
 */
export const getPlayersOnline = async ( options?: Parameters<typeof customFetch>[1]): Promise<PlayerSummary[]> => {
 ...
 */
export const getPlayer = async (id: number, options?: Parameters<typeof customFetch>[1]): Promise<Player> => {
 ...
 */
export const getAvatar = async ( options?: Parameters<typeof customFetch>[1]): Promise<Avatar> => {
 ...
 */
export const saveAvatar = async (avatarInput: AvatarInput, options?: Parameters<typeof customFetch>[1]): Promise<Avatar> => {
 ...
 */
export const getAvatarOptions = async ( options?: Parameters<typeof customFetch>[1]): Promise<AvatarOptions> => {
 ...
 */
export const getChatMessages = async (params?: GetChatMessagesParams, options?: Parameters<typeof customFetch>[1]): Promise<ChatMessage[]> => {
 ...
 */
export const getPlazaStatus = async ( options?: Parameters<typeof customFetch>[1]): Promise<PlazaStatus> => {
 ...
 */
export const getMyRoom = async ( options?: Parameters<typeof customFetch>[1]): Promise<Room> => {
 ...
 */
export const getMyRooms = async ( options?: Parameters<typeof customFetch>[1]): Promise<Room[]> => {
...
export const getGetMyRoomByIdUrl = (roomId: string,) => {
 ...
 */
export const getMyRoomById = async (roomId: string, options?: Parameters<typeof customFetch>[1]): Promise<Room> => {

  return customFetch<Room>(getGetMyRoomByIdUrl(roomId),
  {
    ...options,
    method: 'GET'
...
export const getGetMyRoomByIdQueryKey = (roomId: string,) => {
    return [
    `/api/rooms/mine/${roomId}`
    ] as const;
    }


export const getGetMyRoomByIdQueryOptions = <TData = Awaited<ReturnType<typeof getMyRoomById>>, TError = ErrorType<void>>(roomId: string, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getMyRoomById>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {

const {query: queryOptions, request: requestOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getGetMyRoomByIdQueryKey(roomId);



    const queryFn: QueryFunction<Awaited<ReturnType<typeof getMyRoomById>>> = ({ signal }) => getMyRoomById(roomId, { signal, ...requestOptions });





   return  { queryKey, queryFn, enabled: roomId !== null && roomId !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getMyRoomById>>, TError, TData> & { queryKey: QueryKey }
}

export type GetMyRoomByIdQueryResult = NonNullable<Awaited<ReturnType<typeof getMyRoomById>>>
export type GetMyRoomByIdQueryError = ErrorType<void>
...
export function useGetMyRoomById<TData = Awaited<ReturnType<typeof getMyRoomById>>, TError = ErrorType<void>>(
 roomId: string, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getMyRoomById>>, TError, TData>, request?: SecondParameter<typeof customFetch>}

 ):  UseQueryResult<TData, TError> & { queryKey: QueryKey } {

  const queryOptions = getGetMyRoomByIdQueryOptions(roomId,options)
 ...
 */
export const deleteMyRoom = async (roomId: string, options?: Parameters<typeof customFetch>[1]): Promise<void> => {
 ...
 */
export const getPublicRooms = async ( options?: Parameters<typeof customFetch>[1]): Promise<RoomSummary[]> => {
